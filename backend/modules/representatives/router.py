...
# from backend.core.security import hash_invitation_token
...
#         .filter(
#             Representative.invitation_token_hash == token_hash
#         )
#         .first()
#     )
...
#     if (
#         not representative.invitation_expires_at
...
#         text-align: center;
#     ">
#         <h2>Hello {representative.representative_name}</h2>

#         <p>
#             You have been added as a representative for:
#         </p>

#         <h3>{representative.service}</h3>
...
#         <a
#             href="/representatives/{representative.representative_id}/google/connect"
#             style="
